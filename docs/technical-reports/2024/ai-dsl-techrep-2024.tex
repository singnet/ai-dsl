...
\begin{table}[htbp]
  \centering
  \caption{Bluebird combinator.  A signal of type $a$ get processed by
    $g$ which outputs a signal of type $b$, itself then being
    processed by $f$ which outputs a signal of type $c$.}
  \label{tab:bluebird}
  \begin{tabular}{|l|l|}
    \hline
    Name & bluebird \\
...
\begin{table}[htbp]
  \centering
  \caption{Phoenix combinator.  A signal of type $a$ splits and get
    processed by $g$ and $h$ in parallel, which output signals of
    types $b$ and $c$ respectively, then rejoining to $f$ which
    outputs a signal of type $d$.}
  \label{tab:phoenix}
  \begin{tabular}{|l|l|}
    \hline
    Name & phoenix \\
