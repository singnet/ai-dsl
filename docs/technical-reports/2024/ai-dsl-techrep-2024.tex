...
some well selected uncurried combinators, that we will present next,
led to efficient synthesis of AI service compositions, in our limited
setting anyway.
...
would not as compact as having both the bluebird and the phoenix.}.
