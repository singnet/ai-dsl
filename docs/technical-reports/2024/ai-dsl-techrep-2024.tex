...
\section{The Bluebird and the Phoenix}

The well selected combinators aforementioned are:
\begin{itemize}
\item The \emph{bluebird}, which is just another name for regular
  function composition, used here to simulate sequential composition.
\item The \emph{phoenix}, a less known yet powerful combinator, used
  here to simulate parallel composition.
\end{itemize}
