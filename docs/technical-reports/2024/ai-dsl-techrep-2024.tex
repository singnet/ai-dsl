...
$\texttt{xp}_9$ brings that down to 42.7s.  NEXT: This number may seem
too big but in MeTTaLog it takes less than a second.  Moreover the
number of candidates goes from 29 to 1, only retaining the best
solution.  That is because we have introduced more reduction rules, 6
