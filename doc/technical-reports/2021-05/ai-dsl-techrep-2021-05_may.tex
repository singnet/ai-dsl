...
the prototype and write them in SUO-KIF format;
  \item Similarly we want to be able to convert SUO-KIF specifications
    ...
    each formalism.  To start exploring that we have ported the
    trivial AI services described in Section \ref{aidsl_registry} to
    SUO-KIF, see
...
moved to the function definition as offered by SUO-KIF First Order
Logic expressiveness.  Another aspect we need to explore is how tools,
such as Automatic Theorem Provers
