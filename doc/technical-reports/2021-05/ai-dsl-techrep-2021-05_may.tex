...
\subsection{Description}
The idea is to develop an NLP model using word embedding and train it with kaggle dataset refer https://www.kaggle.com/clmentbisaillon/fake-and-real-news-dataset. 
I implemented a word embedding model based on an article shared by eligijus bujokas on medium refer. Hence, given a dataset or a csv file containing these lines for instance.
