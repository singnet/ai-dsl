...
possible in order to uncover hidden blocks as early as possible.  Let
us summarize what we have accomplished so far and what are the next
steps to bring us closer to a complete AI-DSL.
\begin{itemize}
\item We have experimented with Idris to formalize and reason about
  ...
  Section~\ref{sec:realized_function}.  We have done so in a limited
  manners, only considering additive cost and infimum-itive quality,
  but we have proven that it is possible and tractable to do in Idris.
  More work is required to expand the complexity of such realized
  function attributes, such as functional or distributional costs and
  quality.
\item We have experimented with Idris to formalize function properties
  as dependent types, see Chapter~\ref{chap:soft_eng_strat}.  This was
...
applicability, or by relaxing the level of requirements demanded.
