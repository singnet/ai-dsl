...
entire body here due to its volume (over 70 papers so far) and the
fact that we are still in the process of reviewing it.  Here is
however the most relevant work we have encountered so far.

The most recent and also most relevant work we have found is the
Function Ontology~\cite{FunctionOntology}. Its goal is to define a
standard for describing, formally and informally, functions and their
references to implementations, as well as developing tools for
retrieving and executing them, remotely or locally.  To the best of
our knowledge it does not make use of dependent types or blockchain
technology, however there is a lot of potential for reuse.  More
investigation will be conducted to precisely determine to what extent.

Less relevant, and generally less recent, work with yet potential for
reuse or just inspirational is describe below.
...
requests to each other, worth further exploration.  \cite{Roelofs2020}
is centered around validating the consistency of different ontologies.
This could be useful for facilitating the decentralization of the
AI-DSL and its ontology.  \cite{Witherell2009} introduces FIDOE, a
tool for analyzing and propagating changes across overlapping
ontologies according to predefined inference rules.  It could be
relevant to the ontology part, they mention standards such as
SUMO~\cite{pease_standard_2009} and SWRL~\cite{SWRL} as well.\nil{Add
  Euzenat, J, Isaac, A, Meilicke, C, Shvaik, P, Stuckenschmidt, H,
  Šváb, O, Svátek, V, van Hage, W, Yatskevich, M, “Results of the
  Ontology Alignment Evaluation Initiative 2007”, The Second
  International Workshop on Ontology Matching, Busan Korea, 2007.  As
  well as Lee, M., Jung, M., Suh, J., “Semantic Mapping Based on
  Ontology and Bayesian Network and its Application to CAD and PDM
  Integration,” 2006 ASME Computers and Information in Engineering
  Conference, Philadelphia, PA, September 2006 DETC2006-99419, in
  Github issue}
