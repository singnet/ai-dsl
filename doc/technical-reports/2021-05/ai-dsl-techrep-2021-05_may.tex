...
As described in the blogpost, the current plan is to have
such a system rely on Dependent Types~\cite{Altenkirch05whydependent} to
...
For the first iteration the goals were to
\begin{enumerate}
...
least to some degree.  The last, and the most ambitious, objective is slated
for the next iteration due to its complexity.
...
probably require some form of voting / global consensus on a platform level.
  ...
  will be the true ontology, representable by an  unique root /
