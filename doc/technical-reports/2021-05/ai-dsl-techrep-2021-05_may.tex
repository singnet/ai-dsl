...
\kabir[inline]{Write about matching inputs and outputs of the sevices.}
...
metadata of the servcie to be published on SingularityNET platform.
...
\begin{figure}[H]
  ...
  \href{https://github.com/singnet/ai-dsl/blob/master/ontology/NuNet.kif}{NuNet.kif}
  requres a service to have compute resource (and possibly other) requirements
...
\kabir[inline]{possibly put graphical representations of ontology hierarchy.}
...
driving directions, and the scripts of plays and movies. &
  ...
  \end{tabular}
\captionsetup{width=0.9\linewidth}
\caption{\label{tbl:uclnlp_hierarchy}Full hierarchy of dependencies of \textit{uclnlp} SNet AI service instance within SUMO ontology. The same  hierarchy applies to binary-detection and FakeNewsScore services used in the \textit{Fake News Warning} app.}
\end{table}

\kabir[inline]{Finished here 2021-06-02 02:14}

\section{The mechanism of dynamic workflow construction}
