...
\begin{figure}[h]
	...
	\begin{subfigure}[b]{1\textwidth}
		\centering
		\includegraphics[width=\textwidth]{images/SNetAIService.png}
...
\lstinputlisting[float,caption={\label{lst:dag}Contents of SingularityNet.kif that contains all },captionpos=b,breaklines=true]{images/SingularityNet.kif}
