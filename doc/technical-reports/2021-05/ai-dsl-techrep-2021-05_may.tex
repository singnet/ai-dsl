...
paper is a bit vague but they mention important standards such as the
Agent Communication Language (ACL)~\cite{Labrou99thecurrent} used to
communicate agents specifications to each other.  \cite{Roelofs2020}
is centered around validating the consistency of different ontologies.
This could be relevant towards avoiding centralization of the
ontology.  \cite{Witherell2009} is especially relevant to the ontology
aspect, mentioning standards such as SUMO~\cite{pease_standard_2009}
and SWRL~\cite{SWRL}.
