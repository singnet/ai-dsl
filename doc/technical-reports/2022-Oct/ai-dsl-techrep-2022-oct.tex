...
\begin{abstract}
  ...
  platform.  It focuses primarily on experimenting with formalizing
  mathematical properties of AI algorithms, in particular a descending
  property for the gradient descent algorithm, using the Dependently
  Typed Language (DTL) Idris.  Then it focuses on program synthesis
  applied to the problem of automatically composing AI services to
