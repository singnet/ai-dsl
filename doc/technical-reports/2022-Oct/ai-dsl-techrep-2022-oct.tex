...
Idris hand book~\cite{}.  There is other related work such as Magic
Haskell~\cite{} although fairly limited since such system only
supports case-based descriptions due to the lack of expressive power
of Haskell.  There is other similar work coming from the Inductive
Programming Logic community, essentially suffering from the same
limitations as Magic Haskell.
