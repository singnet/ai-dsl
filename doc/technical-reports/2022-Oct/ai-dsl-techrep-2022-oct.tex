...
properties driven by real world use could include for instance the
undesirability of introducing backdoors during
training~\cite{Menisov2022}, etc.  The breadth and utility of what can
be formalized is simply enormous.
...
Program synthesis is a crucial component TODO
...
\end{enumerate}
Once all this work has been accomplished, improvements could be made
on the following fronts, as time permits:
\begin{enumerate}
