...
\item Contravariant over inputs and covariant over outputs
  ...
  small examples involving function composition, which we leave to the
...
\item Coercion
  ...
  \mintinline{scheme}{nbrLimbs} on the cat \mintinline{scheme}{Choupette}
  can be done with
  \begin{minted}{scheme}
  ...
  (: MA (<: Mammal Animal))
  \end{minted}
  And thus the \mintinline{scheme}{nbrLimbs} call over
