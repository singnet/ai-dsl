...
\item Coercion
  ...
  \mintinline{scheme}{nbrLimbs} on the cat \mintinline{scheme}{Macak}
  can be done with
  \begin{minted}{scheme}
    (nbrLimbs (coerce CA Macak))
  \end{minted}
  ...
  \begin{minted}{scheme}
    (: CA (<: Cat Animal))
  \end{minted}
  and \mintinline{scheme}{Macak} is an inhabitant of
  \mintinline{scheme}{Cat}, formally
  \begin{minted}{scheme}
    (: Macak Cat)
  \end{minted}
  In this example \mintinline{scheme}{(<: Cat Animal)} would be an
  axiom, thus easily proven, but in general it may be necessary to
  build a proof.  For instance, it may not been directly known that
  \mintinline{scheme}{Cat} is a subtype of
  \mintinline{scheme}{Animal}, but instead it may be known
  \mintinline{scheme}{Cat} is a subtype of
