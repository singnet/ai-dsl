module Examples.LogisticLinearRegression
...
import Search.Regression.LogisticLinear
import Search.Util
...
test_logreg =
  ...
  in do -- Generate train and test data
        ...
        let x_d : Matrix sample_size 3 Double
            ...
            model_ls = logisticRegression x_d y eta (beta, maxsteps)
...
test_loglinreg =
  ...
  in do -- Generate train and test data
        ...
        -- Linearized the data set.  The following is not required for
        -- learning and only used to display additional information
        ...
        putStrLn ""
        putBoxedStrLn "Learning"
        let model_ls : (ColVect 3 Double, Nat)
            model_ls = logisticLinearRegression x y eta (beta, maxsteps)
            model : ColVect 3 Double
            model = fst model_ls
            steps : Nat         -- Actual number of steps used
            steps = minus maxsteps (snd model_ls)
